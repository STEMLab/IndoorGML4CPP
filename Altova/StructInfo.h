...
namespace meta
{
	...
	public:
		...
		unsigned GetMaxLength() const { return GetFacetFallback(_T("maxLength"), _T("length"), (unsigned)-1); }
		unsigned GetLength() const { return GetFacetFallback(_T("length"), 0, (unsigned)-1); }
		unsigned GetTotalDigits() const { return GetFacetFallback(_T("totalDigits"), 0, (unsigned)-1); }
		unsigned GetFractionDigits() const { return GetFacetFallback(_T("fractionDigits"), 0, (unsigned)-1); }
