#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CValuePropertyType
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CValuePropertyType
...
class CValuePropertyType : public ElementType
{
public:
	indoorgmlcore_EXPORT CValuePropertyType(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CValuePropertyType(CValuePropertyType const& init);
	...
	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_type, 1, 6> type;	// type CtypeType

	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_href, 0, 0> href;	// href ChrefType

	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_role, 0, 0> role;	// role CroleType

	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_arcrole, 0, 0> arcrole;	// arcrole CarcroleType

	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_title, 0, 0> title;	// title CtitleAttrType
	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_show, 1, 5> show;	// show CshowType
	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_actuate, 1, 4> actuate;	// actuate CactuateType

	MemberAttribute<string_type,_altova_mi_gml_altova_CValuePropertyType_altova_nilReason, 0, 0> nilReason;	// nilReason CNilReasonType
	...
	MemberElement<CBooleanType, _altova_mi_gml_altova_CValuePropertyType_altova_Boolean> Boolean;
	...
	MemberElement<CCategoryType, _altova_mi_gml_altova_CValuePropertyType_altova_Category> Category;
	...
	MemberElement<CCountType, _altova_mi_gml_altova_CValuePropertyType_altova_Count> Count;
	...
	MemberElement<CQuantityType, _altova_mi_gml_altova_CValuePropertyType_altova_Quantity> Quantity;
	...
	MemberElement<gml::CLinearRingType, _altova_mi_gml_altova_CValuePropertyType_altova_LinearRing> LinearRing;
	...
	MemberElement<gml::CSurfaceType, _altova_mi_gml_altova_CValuePropertyType_altova_PolyhedralSurface> PolyhedralSurface;
	...
	MemberElement<gml::CRingType, _altova_mi_gml_altova_CValuePropertyType_altova_Ring> Ring;
	struct Ring { typedef Iterator<gml::CRingType> iterator; };
	MemberElement<gml::CShellType, _altova_mi_gml_altova_CValuePropertyType_altova_Shell> Shell;
	...
	MemberElement<gml::CSurfaceType, _altova_mi_gml_altova_CValuePropertyType_altova_TriangulatedSurface> TriangulatedSurface;
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CValuePropertyType
