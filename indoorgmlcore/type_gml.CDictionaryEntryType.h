#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CDictionaryEntryType
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CDictionaryEntryType
...
class CDictionaryEntryType : public ::indoorgmlcore::gml::CAbstractMemberType
{
public:
	indoorgmlcore_EXPORT CDictionaryEntryType(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CDictionaryEntryType(CDictionaryEntryType const& init);
	...
	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_type, 1, 6> type;	// type CtypeType

	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_href, 0, 0> href;	// href ChrefType

	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_role, 0, 0> role;	// role CroleType

	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_arcrole, 0, 0> arcrole;	// arcrole CarcroleType

	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_title, 0, 0> title;	// title CtitleAttrType
	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_show, 1, 5> show;	// show CshowType
	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_actuate, 1, 4> actuate;	// actuate CactuateType

	MemberAttribute<string_type,_altova_mi_gml_altova_CDictionaryEntryType_altova_nilReason, 0, 0> nilReason;	// nilReason CNilReasonType
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CDictionaryEntryType
