#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CLinearRingType
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CLinearRingType
...
class CLinearRingType : public ::indoorgmlcore::gml::CAbstractRingType
{
public:
	indoorgmlcore_EXPORT CLinearRingType(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CLinearRingType(CLinearRingType const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CLinearRingType
