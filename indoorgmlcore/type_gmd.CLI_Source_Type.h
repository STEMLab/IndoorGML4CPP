#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CLI_Source_Type
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CLI_Source_Type
...
class CLI_Source_Type : public ::indoorgmlcore::gco::CAbstractObject_Type
{
public:
	indoorgmlcore_EXPORT CLI_Source_Type(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CLI_Source_Type(CLI_Source_Type const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CLI_Source_Type
