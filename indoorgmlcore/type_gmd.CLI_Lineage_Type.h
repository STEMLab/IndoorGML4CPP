#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CLI_Lineage_Type
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CLI_Lineage_Type
...
class CLI_Lineage_Type : public ::indoorgmlcore::gco::CAbstractObject_Type
{
public:
	indoorgmlcore_EXPORT CLI_Lineage_Type(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CLI_Lineage_Type(CLI_Lineage_Type const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CLI_Lineage_Type
