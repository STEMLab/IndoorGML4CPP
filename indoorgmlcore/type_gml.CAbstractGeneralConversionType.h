#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CAbstractGeneralConversionType
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CAbstractGeneralConversionType
...
class CAbstractGeneralConversionType : public ElementType
{
public:
	indoorgmlcore_EXPORT CAbstractGeneralConversionType(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CAbstractGeneralConversionType(CAbstractGeneralConversionType const& init);
	...
	MemberElement<CdomainOfValidityType, _altova_mi_gml_altova_CAbstractGeneralConversionType_altova_domainOfValidity> domainOfValidity;
	...
	MemberElement<CcoordinateOperationAccuracyType, _altova_mi_gml_altova_CAbstractGeneralConversionType_altova_coordinateOperationAccuracy> coordinateOperationAccuracy;
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CAbstractGeneralConversionType
