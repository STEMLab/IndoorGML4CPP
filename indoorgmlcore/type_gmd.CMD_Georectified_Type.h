#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_Georectified_Type
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_Georectified_Type
...
class CMD_Georectified_Type : public ::indoorgmlcore::gmd::CMD_GridSpatialRepresentation_Type
{
public:
	indoorgmlcore_EXPORT CMD_Georectified_Type(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CMD_Georectified_Type(CMD_Georectified_Type const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_Georectified_Type
