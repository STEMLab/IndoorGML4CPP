#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CRangeSetType
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CRangeSetType
...
class CRangeSetType : public ElementType
{
public:
	indoorgmlcore_EXPORT CRangeSetType(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CRangeSetType(CRangeSetType const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CRangeSetType
