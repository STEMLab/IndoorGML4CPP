#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_ImageDescription_Type
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_ImageDescription_Type
...
class CMD_ImageDescription_Type : public ::indoorgmlcore::gmd::CMD_CoverageDescription_Type
{
public:
	indoorgmlcore_EXPORT CMD_ImageDescription_Type(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CMD_ImageDescription_Type(CMD_ImageDescription_Type const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_ImageDescription_Type
