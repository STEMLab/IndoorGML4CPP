#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_TopicCategoryCode_Type
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_TopicCategoryCode_Type
...
{
public:
	indoorgmlcore_EXPORT CMD_TopicCategoryCode_Type(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CMD_TopicCategoryCode_Type(CMD_TopicCategoryCode_Type const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_TopicCategoryCode_Type
