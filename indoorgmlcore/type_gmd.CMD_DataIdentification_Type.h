#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_DataIdentification_Type
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_DataIdentification_Type
...
class CMD_DataIdentification_Type : public ::indoorgmlcore::gmd::CAbstractMD_Identification_Type
{
public:
	indoorgmlcore_EXPORT CMD_DataIdentification_Type(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CMD_DataIdentification_Type(CMD_DataIdentification_Type const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gmd_ALTOVA_CMD_DataIdentification_Type
