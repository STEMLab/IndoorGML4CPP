#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CMovingObjectStatusType
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CMovingObjectStatusType
...
class CMovingObjectStatusType : public ::indoorgmlcore::gml::CAbstractTimeSliceType
{
public:
	indoorgmlcore_EXPORT CMovingObjectStatusType(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CMovingObjectStatusType(CMovingObjectStatusType const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CMovingObjectStatusType
