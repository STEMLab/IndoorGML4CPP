#ifndef _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CCurveSegmentArrayPropertyType
#define _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CCurveSegmentArrayPropertyType
...
class CCurveSegmentArrayPropertyType : public ElementType
{
public:
	indoorgmlcore_EXPORT CCurveSegmentArrayPropertyType(MSXML2::IXMLDOMNodePtr const& init);
	indoorgmlcore_EXPORT CCurveSegmentArrayPropertyType(CCurveSegmentArrayPropertyType const& init);
...
#endif // _ALTOVA_INCLUDED_indoorgmlcore_ALTOVA_gml_ALTOVA_CCurveSegmentArrayPropertyType
